...
from mbox.vendor.Qt import QtWidgets
from mbox.vendor.Qt import QtCompat
from mbox.vendor.Qt import QtGui
from mbox.vendor.Qt import QtSvg
from mbox.vendor.six import PY2
...
def show_dialog(dialog, dInst=True, dockable=False, *args):
    """
...
def delete_instances(dialog, checkinstance):
