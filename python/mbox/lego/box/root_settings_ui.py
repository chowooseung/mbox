...
################################################################################
## Form generated from reading UI file 'root_settings_ui.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.jointRig_checkBox = QCheckBox(self.groupBox_3)
        self.jointRig_checkBox.setObjectName(u"jointRig_checkBox")
        ...
        self.connect_joints_checkBox = QCheckBox(self.groupBox_3)
        self.connect_joints_checkBox.setObjectName(u"connect_joints_checkBox")
        ...
        self.worldCtl_checkBox = QCheckBox(self.groupBox_7)
        self.worldCtl_checkBox.setObjectName(u"worldCtl_checkBox")

        self.horizontalLayout_9.addWidget(self.worldCtl_checkBox)

        self.worldCtl_lineEdit = QLineEdit(self.groupBox_7)
        self.worldCtl_lineEdit.setObjectName(u"worldCtl_lineEdit")
        ...
        self.rigName_lineEdit = QLineEdit(self.groupBox)
        self.rigName_lineEdit.setObjectName(u"rigName_lineEdit")

        self.formLayout.setWidget(0, QFormLayout.FieldRole, self.rigName_lineEdit)
        ...
        self.formLayout.setWidget(1, QFormLayout.FieldRole, self.mode_comboBox)
        ...
        self.notes_textEdit = QTextEdit(Form)
        self.notes_textEdit.setObjectName(u"notes_textEdit")

        self.gridLayout_2.addWidget(self.notes_textEdit, 4, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.jointRig_checkBox.setText(QCoreApplication.translate("Form", u"Separated Joint Structure", None))
        ...
        self.connect_joints_checkBox.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>When this option is active, mGear Shifter will try to connect to existing joints in the scene</p><p><span style=\" font-weight:600;\">WARNING</span>: The joints need to have the rotation values freeze to 0, 0, 0. </p><p>Use Maya's Modify &gt;&gt; Freeze Transformation command to Freeze rotation. Open the command options and ensure only Rotation is freeze, before execute the command</p><p>Freeze joint rotations steps:</p><p>1. Select all joints to freeze</p><p>2. Open Maya's Modify &gt;&gt; Freeze Transformation options and ensure only rotation is checked</p><p>3. Apply Modify &gt;&gt; Freeze Transformation</p><p><br/></p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.connect_joints_checkBox.setText(QCoreApplication.translate("Form", u"Connect to existing joints. NOTE: Joints need to have freezed rotations values.", None))
        self.groupBox_7.setTitle(QCoreApplication.translate("Form", u"Base Rig Control", None))
#if QT_CONFIG(tooltip)
        self.worldCtl_checkBox.setToolTip(QCoreApplication.translate("Form", u"<html><head/><body><p>Shifter creates by default a Base control called &quot;<span style=\" font-weight:600;\">global_C0_ctl</span>&quot;. </p><p>Since this control is not accesible from any guide locator. Is not possible to add it as a space reference.</p><p>If this option is active, The base control will be named &quot;<span style=\" font-weight:600;\">world_ctl</span>&quot; and we can add &quot;<span style=\" font-weight:600;\">global_C0_ctl</span>&quot; as a regular &quot;Control_01&quot; component. </p><p>This way we can use it as space reference.</p><p>The biped guide template is configured with this structure.</p></body></html>", None))
#endif // QT_CONFIG(tooltip)
        self.worldCtl_checkBox.setText(QCoreApplication.translate("Form", u"Use World Ctl or Custom Name", None))
        self.worldCtl_lineEdit.setText(QCoreApplication.translate("Form", u"world_ctl", None))
        self.groupBox.setTitle(QCoreApplication.translate("Form", u"Rig Settings", None))
        self.rigName_label.setText(QCoreApplication.translate("Form", u"Rig Name", None))
        self.mode_label.setText(QCoreApplication.translate("Form", u"Debug Mode", None))
        self.mode_comboBox.setItemText(0, QCoreApplication.translate("Form", u"WIP", None))
        self.mode_comboBox.setItemText(1, QCoreApplication.translate("Form", u"PUB", None))

        self.step_label.setText(QCoreApplication.translate("Form", u"Guide Build Steps:", None))
        self.step_comboBox.setItemText(0, QCoreApplication.translate("Form", u"All Steps", None))
        self.step_comboBox.setItemText(1, QCoreApplication.translate("Form", u"PreScripts", None))
        ...
        self.step_comboBox.setItemText(4, QCoreApplication.translate("Form", u"Operators", None))
        self.step_comboBox.setItemText(5, QCoreApplication.translate("Form", u"Connection", None))
        self.step_comboBox.setItemText(6, QCoreApplication.translate("Form", u"AdditionalFunc", None))
        self.step_comboBox.setItemText(7, QCoreApplication.translate("Form", u"PostScripts", None))
