...
# Form implementation generated from reading ui file 'D:/pipeline/inhouse/DCC/maya/int/modules/rigging/mbox/python/mbox/lego/customstepdesign.ui',
# licensing of 'D:/pipeline/inhouse/DCC/maya/int/modules/rigging/mbox/python/mbox/lego/customstepdesign.ui' applies.
#
# Created: Mon Jul  5 20:40:59 2021
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(QtWidgets.QApplication.translate("Form", "Custom Steps", None, -1))
        self.preCustomStep_checkBox.setText(QtWidgets.QApplication.translate("Form", "Pre Custom Step", None, -1))
        self.preCustomStepAdd_pushButton.setText(QtWidgets.QApplication.translate("Form", "Add", None, -1))
        self.preCustomStepNew_pushButton.setText(QtWidgets.QApplication.translate("Form", "New", None, -1))
        self.preCustomStepDuplicate_pushButton.setText(QtWidgets.QApplication.translate("Form", "Duplicate", None, -1))
        self.preCustomStepRemove_pushButton.setText(QtWidgets.QApplication.translate("Form", "Remove", None, -1))
        self.preCustomStepRun_pushButton.setText(QtWidgets.QApplication.translate("Form", "Run Sel.", None, -1))
        self.preCustomStepEdit_pushButton.setText(QtWidgets.QApplication.translate("Form", "Edit", None, -1))
        self.preCustomStepExport_pushButton.setText(QtWidgets.QApplication.translate("Form", "Export", None, -1))
        self.preCustomStepImport_pushButton.setText(QtWidgets.QApplication.translate("Form", "Import", None, -1))
        self.postCustomStep_checkBox.setText(QtWidgets.QApplication.translate("Form", "Post  Custom Step", None, -1))
        self.postCustomStepAdd_pushButton.setText(QtWidgets.QApplication.translate("Form", "Add", None, -1))
        self.postCustomStepNew_pushButton.setText(QtWidgets.QApplication.translate("Form", "New", None, -1))
        self.postCustomStepDuplicate_pushButton.setText(QtWidgets.QApplication.translate("Form", "Duplicate", None, -1))
        self.postCustomStepRemove_pushButton.setText(QtWidgets.QApplication.translate("Form", "Remove", None, -1))
        self.postCustomStepRun_pushButton.setText(QtWidgets.QApplication.translate("Form", "Run Sel.", None, -1))
        self.postCustomStepEdit_pushButton.setText(QtWidgets.QApplication.translate("Form", "Edit", None, -1))
        self.postCustomStepExport_pushButton.setText(QtWidgets.QApplication.translate("Form", "Export", None, -1))
        self.postCustomStepImport_pushButton.setText(QtWidgets.QApplication.translate("Form", "Import", None, -1))
